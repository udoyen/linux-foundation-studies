...
#
# Version 7.4: 2018-07-14
#     - Add detection of an unsolvable package install on debian
#===============================================================================
VERSION=7.4
...
FALLBACK=(
    ...
    [Debian-999]="Debian-9 Ubuntu-18.04"
    [Fedora]="RHEL CentOS"
    [Fedora-25]="Fedora"
    [Fedora-26]="Fedora-25"
    [Fedora-27]="Fedora-26"
    ...
    [LinuxMint-18.2]="LinuxMint-18.1 LinuxMint-18 Ubuntu-16.04 Debian-9"
    [LinuxMint-18.3]="LinuxMint-18.2 LinuxMint-18.1 LinuxMint-18 Ubuntu-16.04 Debian-9"
    ...
    [Ubuntu-16.04]="Ubuntu-14.04 Debian-8"
    [Ubuntu-17.10]="Ubuntu-16.04 Debian-9"
    [Ubuntu-18.04]="Ubuntu-17.10 Ubuntu-16.04 Debian-9"
...
DISTRO_ALIASES=(
    ...
    [Ubuntu-LTS]="Ubuntu-12.04 Ubuntu-14.04 Ubuntu-16.04 Ubuntu-18.04"
    [Ubuntu-12.04+LTS]="Ubuntu-12.04 Ubuntu-14.04 Ubuntu-16.04 Ubuntu-18.04"
    [Ubuntu-12.04+LTS+]="Ubuntu-12.04 Ubuntu-14.04 Ubuntu-16.04 Ubuntu-18.04+"
...
declare -A ARCH BOGOMIPS BOOT CONFIGS CPUFLAGS CPUS \
    ...
    COPYPACKAGES RECOMMENDS SUGGESTS RUNCODE VERSIONS VMOKAY EXTRAS VMS INCLUDES \
...
DISTROS[LFD]="CentOS-7+ Debian-8+ Fedora-26+ LinuxMint-18+ openSUSE-42.3+ openSUSE-15 RHEL-7+ Ubuntu-16.04+LTS+ SLES-12+"
DISTROS[EMBEDDED]="Debian-9+ Fedora-27+ LinuxMint-18+ openSUSE-42.3+ openSUSE-15 Ubuntu-16.04+LTS+"
DISTROS[LFS]="CentOS-7+ Debian-8+ Fedora-26+ LinuxMint-17+ openSUSE-42.3+ openSUSE-15 RHEL-7+ Ubuntu-14.04+LTS+ SLES-12+"
DISTRO_BL="CentOS-5 CentOS-6 Debian-7 RHEL-6 LinuxMint-16 Ubuntu-12.04 Ubuntu-12.10 Ubuntu-13.04 Ubuntu-13.10 Ubuntu-14.10 Ubuntu-15.04 Ubuntu-15.10 Ubuntu-16.10 Ubuntu-17.04"
DISTRO_BL[EMBEDDED]="CentOS-5 CentOS-6 CentOS-7 Debian-7 Debian-8 RHEL-5 RHEL-6 RHEL-7 LinuxMint-16 LinuxMint-17 Ubuntu-12.04 Ubuntu-12.10 Ubuntu-13.04 Ubuntu-13.10 Ubuntu-14.10 Ubuntu-15.04 Ubuntu-15.10 Ubuntu-16.10 Ubuntu-17.04 Ubuntu-17.10"
#INCLUDES=
EXTRAS=
VMS=
#-------------------------------------------------------------------------------
...
SUGGESTS[Debian-999_@common]="[Ubuntu-18.04_@common]"
#-------------------------------------------------------------------------------
...
SUGGESTS[Ubuntu-16.04_@kernel]="qt4-dev-tools"
#-------------------------------------------------------------------------------
SUGGESTS[LinuxMint-17_@kernel]="qt4-default libglade2-dev"
#-------------------------------------------------------------------------------
...
#===============================================================================
TITLE[LFD201]="Essentials of Linux System Administration"
WEBPAGE[LFD201]="$LFDTRAINING/essentials-of-linux-system-administration"
INPERSON[LFD201]=n
VIRTUAL[LFD201]=n
SELFPACED[LFD201]=y
#-------------------------------------------------------------------------------
...
PACKAGES[Debian-999_LFD415]="[Ubuntu-16.04_LFD415] -lib32ncurses5-dev"
#-------------------------------------------------------------------------------
...
DISTROS_BL[LFD435]="${DISTROS_BL[EMBEDDED]}"
...
RECOMMENDS[Debian-7_LFD450]="-gcc-arm-linux-gnueabihf -libc6-dev-armhf-cross"
...
PACKAGES[Fedora-25_LFD450]="-python2-devel python-devel"
PACKAGES[Fedora-26_LFD450]="-"
...
DISTROS_BL[LFD460]="${DISTROS_BL[EMBEDDED]}"
# shellcheck disable=SC2034
...
PACKAGES[LFD460]="@build @common @embedded chrpath cpio diffstat
	python python-ply python-progressbar socat xmlto xterm"
#-------------------------------------------------------------------------------
...
PACKAGES[Ubuntu-18.04_LFD460]="-libnfs8"
...
PACKAGES[openSUSE-42.2_LFS426]="iozone"
PACKAGES[openSUSE-999_LFS426]="[openSUSE-42.2_LFS426]"
...
PACKAGES[Ubuntu-17.10_LFS462]="ebtables firewalld"
...
pkg_list_lookup() {
    ...
    LIST=$(get_db "$TYPE" "" "$DID" "$DVER"; get_db "$TYPE" "$ACTIVITY" "$DID" "$DVER")
    # shellcheck disable=SC2086
    debug 2 "  pkg_list_lookup: $TYPE DID=$DID DVER=$DVER ACTIVITY=$ACTIVITY LIST="$LIST
    echo "$LIST"
}
...
package_list() {
    ...
    # shellcheck disable=SC2086
    debug 1 "  package_list: PACKAGES LIST="$PLIST
    if [[ -z $NORECOMMENDS ]] ; then
        # shellcheck disable=SC2046,SC2086
        RLIST=$(pkg_list_expand RECOMMENDS "$DID" "$DVER" $RLIST)
        # shellcheck disable=SC2086
        debug 1 "  package_list: RECOMMENDS LIST="$RLIST
    fi
    if [[ -z $NOSUGGESTS ]] ; then
        # shellcheck disable=SC2046,SC2086
        SLIST=$(pkg_list_expand SUGGESTS "$DID" "$DVER" $SLIST)
        # shellcheck disable=SC2086
        debug 1 "  package_list: SUGGESTS LIST="$SLIST
    fi
